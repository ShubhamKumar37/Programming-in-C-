        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorId = table.Column<int>(type: "int", nullable: false),
                    PublisherId = table.Column<int>(type: "int", nullable: false),
                    PublisherNavigationId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Books", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Books_Authors_PublisherId",
                        column: x => x.PublisherId,
                        principalTable: "Authors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Books_Publishers_PublisherNavigationId",
                        column: x => x.PublisherNavigationId,
                        principalTable: "Publishers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_PublisherNavigationId",
                table: "Books",
                column: "PublisherNavigationId");
        }
